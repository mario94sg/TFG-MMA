...
<head>
  ...
  <script src="../../js/foro_entrenador.js"></script>
  ...
  <div class="container mt-4">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark rounded px-3">
      <div class="container-fluid">
        <a class="navbar-brand fw-bold" href="foro_entrenador.php">Foro</a>
  ...
  <div class="modal fade" id="modalConfirm" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body" id="modalConfirmBody">¿Estás seguro?</div>
        <div class="modal-footer">
