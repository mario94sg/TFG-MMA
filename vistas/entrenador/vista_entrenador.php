...
<body>
  <div class="container mt-4">
    <h1 class="text-center mb-4">Tzinavos Team MMA - Entrenador <?= htmlspecialchars($_SESSION['nombre']) ?></h1>
    <nav class="mb-4 text-center">
      <a href="vista_entrenador.php" class="btn btn-primary me-2">Inicio</a>
      ...
      <a href="foro_entrenador.php" class="btn btn-outline-primary">Nutrición</a>
