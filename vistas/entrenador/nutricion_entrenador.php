...
<head>
  ...
  <link rel="stylesheet" href="../../css/nutricion_entrenador.css">
</head>

<body>
  <div class="container mt-4">
    <h1 class="text-center mb-4">Tzinavos Team MMA Nutrición - Entrenador <?= htmlspecialchars($_SESSION['nombre']) ?></h1>
    <nav class="mb-4 text-center">
      ...
      <a href="foro_entrenador.php" class="btn btn-primary me-2">Nutrición</a>
